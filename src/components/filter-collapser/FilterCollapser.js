...
FilterCollapser.prototype.createButton = function() {
	...
	this.button = $('<button type="button" aria-expanded="true"></button>')
.text(this.legend.text())
.append('<svg viewBox="0 0 10 10" aria-hidden="true" focusable="false"><rect class="vert" height="8" width="2" y="1" x="4" /> <rect height="2" width="8" y="4" x="1" /> </svg>')
